...
namespace MoleculeEfficienceTracker
{
    ...
    where TCalculator : IMoleculeCalculator, new()
    {
        ...
        protected async void OnAddDoseClicked(object sender, EventArgs e)
        {
            ...
            System.Diagnostics.Debug.WriteLine($"[BaseMoleculePage Debug] OnAddDoseClicked - Weight from UserPreferences: {weight}, DoseMg: {doseMg}");
        ...
        protected void UpdateConcentrationDisplay()
        {
            ...
            double amount = Calculator.CalculateTotalAmount(Doses.ToList(), currentTime);

            ConcentrationOutputLabel.Text = $"{amount:F2} {Calculator.DoseUnit} ({concentration:F2} {Calculator.ConcentrationUnit})";
